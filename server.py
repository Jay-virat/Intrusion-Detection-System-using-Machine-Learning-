...
# Flask Web App for intrusion detection.
# Takes user input (traffic_type).
# Calls main() from eval.py to classify the attack.
# Displays results on a webpage (result.html).